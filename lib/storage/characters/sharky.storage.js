...
export const SHARKY_LONG_WAITING = [
...
export const SHARKY_BUBBLE_ATTACK = [
...
export const SHARKY_POISON_BUBBLE_ATTACK = [
...
export const SHARKY_ELECTRIC_SHOCK = [
...
export const SHARKY_HURT_POISONED = [
...
export const SHARKY_DEAD_POISONED = [
