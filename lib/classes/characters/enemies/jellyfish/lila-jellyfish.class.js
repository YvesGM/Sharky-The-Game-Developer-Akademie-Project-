import { LILA_JELLYFISH_SWIMMING, LILA_JELLYFISH_DEAD, LILA_JELLYFISH_SUPER_DEAD, LILA_JELLYFISH_SUPER_DANGEROUS } from "../../../../storage/characters/enemies/jellyfish.storage.js";
...
export default class LilaJellyfishClass extends MovableObjectsClass {
    ...
    draw(ctx) {
        ...
        if (this.isSuperDangerousActive()) {
            this.animateCharacters(LILA_JELLYFISH_SUPER_DANGEROUS);
            super.drawImg(ctx);
            return;
        }
    ...
    loadImgStorage() {
        ...
        this.drawFrames(LILA_JELLYFISH_DEAD);
        this.drawFrames(LILA_JELLYFISH_SUPER_DEAD);
        this.drawFrames(LILA_JELLYFISH_SUPER_DANGEROUS);
    }
}