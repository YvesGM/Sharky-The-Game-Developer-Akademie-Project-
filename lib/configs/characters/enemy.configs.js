...
export const ENEMIES = [
    ...
    // second Enemy-Wave
    new GreenPufferfishClass(400 + secondWaveX, 800, 200, 200, 10, "./assets/img/2.Enemy/1.Pufferfish/1.Swim/1.swim1.png"),
    ...
    new RainbowPufferfishClass(2600 + secondWaveX, 750, 200, 200, 10, "./assets/img/2.Enemy/1.Pufferfish/1.Swim/3.swim1.png"),
    new LilaJellyfishClass(2800 + secondWaveX, 180, 400, 400, 10, "./assets/img/2.Enemy/2 Jellyfish/Regular damage/Lila 1.png"),
    new RedPufferfishClass(3600 + secondWaveX, 50, 200, 200, 10, "./assets/img/2.Enemy/1.Pufferfish/1.Swim/2.swim1.png"),
    ...
    new YellowJellyfishClass(1800 + thirdWaveX, -100, 400, 400, 10, "./assets/img/2.Enemy/2 Jellyfish/Regular damage/Yellow 1.png"),
    new RainbowPufferfishClass(3800 + thirdWaveX, 650, 200, 200, 10, "./assets/img/2.Enemy/1.Pufferfish/1.Swim/3.swim1.png"),

    // Final Boss
    new BossClass(17100, 210, 650, 650, 10, "./assets/img/2.Enemy/3 Final Enemy/2.floating/1.png")
]